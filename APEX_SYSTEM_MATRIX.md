...
This node (`pipecat`) is officially registered as part of the APEX system. Any autonomous agent or subagent executing inside this folder must align its actions with the global parameters and register findings back to the `mycorrhizal_network.json` ledger.
